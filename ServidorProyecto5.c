...
int CreaPartida(char listausuarios[200], int socket)//devuelve -1 si están ocupadas todas, el id de partida si no
{
	int g=0;
...
void *AtenderCliente (void *socket)
{
	...
	while (terminar ==0)
	{
		...
		if (codigo !=0 && codigo != 8 && codigo != 9 && codigo != 10 && codigo != 11)
		{
...
int main(int argc, char *argv[])
{
	...
	serv_adr.sin_port = htons(9050);//para shiva poner variable puerto
